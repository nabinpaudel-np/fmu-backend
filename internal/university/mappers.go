...
func toCreateUniversityResponse(u sqlc.University) *CreateUniversityResponse {
	return &CreateUniversityResponse{
		...
		Continent:                derefString(u.Continent),
...
// nullableNumeric converts a float64 (already known to be present because
// the PATCH pointer is non-nil) into a pgtype.Numeric that scans cleanly into
// a numeric column.
